...
const Policy = ({ open, onClose }) => {
  return (
    <Dialog
      open={open}
      PaperProps={{
        sx: { paddingTop: 8, paddingBottom: 4, paddingX: 4 },
      }}
      fullScreen
    >
      <Box position="fixed" left={0} right={0} top={0} bgcolor="#fff">
        <DialogTitle sx={{ m: 0, p: 2 }}>นโยบายความเป็นส่วนตัว</DialogTitle>
        <IconButton
          onClick={onClose}
          sx={{
            position: 'absolute',
      ...
      <p>
        นามบัตรดี ให้ความสำคัญกับการคุ้มครองข้อมูลส่วนบุคคลของคุณ
      ...
      <p>
        ...
        คุณสามารถกด "ยกเลิกการติดต่อ" ในลิงก์อีเมลหรือติดต่อมายังอีเมลของเราได้
      </p>
      ...
      <p>นโยบายนี้แก้ไขล่าสุดและมีผลใช้บังคับตั้งแต่วันที่ 27 สิงหาคม 2566</p>
      ...
      <p>Facebook : TikCard นามบัตรดิจิทัล</p>
    </Dialog>
  );
};
